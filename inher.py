...
class AreaCalculatorAll:
    # Base class with methods for calculating the area of different shapes
    def calculate_circle_area(self, radius):
        return math.pi * radius ** 2
...
class Circle(AreaCalculatorAll):
    # Circle class inheriting from AreaCalculatorAll
    def __init__(self):
...
class Rectangle(AreaCalculatorAll):
    # Rectangle class inheriting from AreaCalculatorAll
    def __init__(self):
...
class Triangle(AreaCalculatorAll):
    # Triangle class inheriting from AreaCalculatorAll
    def __init__(self):
